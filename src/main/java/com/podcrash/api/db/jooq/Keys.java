...
import com.podcrash.api.db.jooq.tables.records.DescriptionsRecord;
import com.podcrash.api.db.jooq.tables.records.KitsRecord;
import com.podcrash.api.db.jooq.tables.records.LocationsRecord;
import com.podcrash.api.db.jooq.tables.records.PermissionsRecord;
...
public class Keys {
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<KitsRecord, PlayersRecord> KITS__KITS_FOREIGN_PLAYER_ID = Internal.createForeignKey(Keys.PLAYERS__PRIMARY_PLAYER_ID, Kits.KITS, "kits__KITS_foreign_player_id", Kits.KITS.PLAYER_ID);
        public static final ForeignKey<PermissionsRecord, PlayersRecord> PERMISSIONS__PERMISSIONS_FOREIGN_PLAYER_ID = Internal.createForeignKey(Keys.PLAYERS__PRIMARY_PLAYER_ID, Permissions.PERMISSIONS, "permissions__PERMISSIONS_foreign_player_id", Permissions.PERMISSIONS.PLAYER_ID);
    }
}
